...
public class TowerLvl7 extends Tower{
    public TowerLvl7(MFrame frame, Point center, ArrayList<Mob> mobs) {
        super(frame, center, mobs);
        this.attackDamage = 210;
        this.currentPriceOfUpdate = 700;
        this.currentLvl = 7;
    }
    ...
    public void paint(Graphics g) {
        ...
        String adr = "images\\towers\\tlvl7.png";
