 ...
 * @author 1
 */
public class TowerLvl8 extends Tower{
    public TowerLvl8(MFrame frame, Point center, ArrayList<Mob> mobs) {
        super(frame, center, mobs);
        this.attackDamage = 240;
        this.currentPriceOfUpdate = 800;
        this.currentLvl = 8;
    }
    ...
    public void paint(Graphics g) {
        ...
        String adr = "images\\towers\\tlvl8.png";
