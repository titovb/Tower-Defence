...
public class TowerLvl5 extends Tower{
    
    public TowerLvl5(MFrame frame, Point center, ArrayList<Mob> mobs) {
        super(frame, center, mobs);
        this.attackDamage = 150;
        this.currentPriceOfUpdate = 500;
        this.currentLvl = 5;
    }
    ...
    public void paint(Graphics g) {
        ...
        String adr = "images\\towers\\tlvl5.png";
