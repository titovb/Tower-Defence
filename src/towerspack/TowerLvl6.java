 ...
 * @author 1
 */
public class TowerLvl6 extends Tower{
    
    public TowerLvl6(MFrame frame, Point center, ArrayList<Mob> mobs) {
        super(frame, center, mobs);
        this.attackDamage = 180;
        this.currentPriceOfUpdate = 600;
        this.currentLvl = 6;
    }
    ...
    public void paint(Graphics g) {
        ...
        String adr = "images\\towers\\tlvl6.png";
