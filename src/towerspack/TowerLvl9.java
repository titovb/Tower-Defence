 ...
 * @author 1
 */
public class TowerLvl9 extends Tower{
    
    public TowerLvl9(MFrame frame, Point center, ArrayList<Mob> mobs) {
        super(frame, center, mobs);
        this.attackDamage = 270;
        this.currentPriceOfUpdate = 999;
        this.currentLvl = 9;
    }
    ...
    public void paint(Graphics g) {
        ...
        String adr = "images\\towers\\tlvl9.png";
