 ...
 * @author 1
 */
public class TowerLvl2 extends Tower{

    public TowerLvl2(MFrame frame, Point center, ArrayList<Mob> mobs) {
        super(frame, center, mobs);
        this.attackDamage = 60;
        this.currentPriceOfUpdate = 200;
        this.currentLvl = 2;
    }
    ...
    public void paint(Graphics g) {
        ...
        String adr = "images\\towers\\tlvl2.png";
