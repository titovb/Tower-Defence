 ...
 * @author 1
 */
public class TowerLvl3 extends Tower{

    public TowerLvl3(MFrame frame, Point center, ArrayList<Mob> mobs) {
        super(frame, center, mobs);
        this.attackDamage = 90;
        this.currentPriceOfUpdate = 300;
        this.currentLvl = 3;
    }
    ...
    public void paint(Graphics g) {
        ...
        String adr = "images\\towers\\tlvl3.png";
